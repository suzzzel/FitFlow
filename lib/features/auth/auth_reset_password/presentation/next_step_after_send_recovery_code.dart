...
class NextStepAfterSendRecoveryCodeButton extends ConsumerStatefulWidget {
  const NextStepAfterSendRecoveryCodeButton({super.key});
...
class _NewNextStepAfterSendRecoveryCodeButtonState
    extends ConsumerState<NextStepAfterSendRecoveryCodeButton> {
